			...
			<section className="container mx-auto max-w-5xl px-4 py-14">
				...
				>
					...
					<p className="mx-auto mt-4 max-w-2xl text-pretty text-muted-foreground">
						Authentication, API, and UI primitives wired up so you can focus on your product. Minimal UI,
						delightful DX.
					</p>
					...
					>
						<Card>
							<CardHeader>
								...
								<CardDescription>End-to-end types with tRPC and strict TS rules.</CardDescription>
							</CardHeader>
							<CardContent>
								<p className="text-muted-foreground text-sm">
									Move fast without breaking types. Autocomplete from server to client.
								</p>
							</CardContent>
						</Card>
					</motion.div>
					...
					>
						<Card>
							<CardHeader>
								...
								<CardDescription>Sign up, sign in, and session handling done.</CardDescription>
							</CardHeader>
							<CardContent>
								<p className="text-muted-foreground text-sm">
									Production-grade primitives with sensible defaults out of the box.
								</p>
							</CardContent>
						</Card>
					</motion.div>
					...
					>
						<Card>
							<CardHeader>
								...
								<CardDescription>Prebuilt components with a11y and theming.</CardDescription>
							</CardHeader>
							<CardContent>
								<p className="text-muted-foreground text-sm">
									Clean, minimal, and responsive. Dark mode supported by default.
								</p>
							</CardContent>
						</Card>
					</motion.div>
					...
					<Card>
						<CardHeader className="flex-row items-center justify-between gap-4">
							<div>
								...
								<CardDescription>Quick glance at your connected services.</CardDescription>
							</div>
